 ...
 *
 * This component displays the site title and provides links to the Home,
 * Articles and Videos pages.  On smaller screens the links collapse into a
 * hamburger menu which can be toggled open or closed.
 */
function Navbar() {
  ...
  // Base link classes; activeClassName applies when the route matches
  const baseLink =
          ...
          <div className="md:hidden">
            ...
            >
              ...
              {!open ? (
                ...
                // Icon when menu is open. Heroicon name: x-mark
                <svg
                  className="block h-6 w-6"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
